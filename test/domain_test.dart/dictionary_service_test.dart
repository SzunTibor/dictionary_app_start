...
// import '../../domain/dicionary_service/english_dictionary_service.dart';
...
//       when(() => mockWordStorage.query(prefix)).thenAnswer((_) async => filteredWords);
...
//       // Arrange
//       final List<Word> words = [const Word(text: 'test1', value: 1), const Word(text: 'test2', value: 2)];
...
//       // Assert
//       expect(response.type, equals(ResponseType.success));
//       verify(() => mockWordStorage.saveAll(words)).called(1); // Verify that saveAll was called once with the list of words
//     });
